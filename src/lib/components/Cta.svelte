<!-- CTA -->
<div class="bg-safetyGreen-500 dark:bg-tango-700 mt-32 sm:mt-48">
		...
		<div class="mx-auto max-w-2xl text-center">
			...
			<div class="mt-10 flex items-center justify-center gap-x-6">
				<a
					...
					class="inline-flex items-center gap-x-1.5 rounded-md bg-white dark:bg-white px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-tango-600 dark:focus-visible:outline-safetyGreen-600"
