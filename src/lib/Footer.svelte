		...
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			<div class="space-y-8">
				...
				<div class="flex space-x-6">
					...
					{/if}
					{#if instagram}
						<a href={instagram} class="text-gray-400 dark:text-gray-600 hover:text-gray-500">
					...
					{/if}
					{#if twitter}
						<a href={twitter} class="text-gray-400 dark:text-gray-600 hover:text-gray-500">
					...
					{/if}
					{#if github}
						<a href={github} class="text-gray-400 dark:text-gray-600 hover:text-gray-500">
					...
					{/if}
					{#if youtube}
						<a href={youtube} class="text-gray-400 dark:text-gray-600 hover:text-gray-500">
