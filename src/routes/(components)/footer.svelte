        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm text-gray-600 dark:text-gray-400">Licensed & Insured</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <Clock class="w-5 h-5 text-green-600" />
                        <span class="text-sm text-gray-600 dark:text-gray-400">Available 24/7 for Emergencies</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <Award class="w-5 h-5 text-green-600" />
                        <span class="text-sm text-gray-600 dark:text-gray-400">Over 15 Years of Excellence</span>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <!-- Navigation Links -->
                    <div>
                        <h3 class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Quick Links</h3>
                        {#if SITE_DATA.routes}
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <Button href="/" variant="link" class="text-sm capitalize">
                                        Home
                                    </Button>
                                </li>
                                {#each SITE_DATA.routes as { id, url }}
                                    <li>
                                        <Button href={url} variant="link" class="text-sm capitalize">
                                            {id}
                                        </Button>
                                    </li>
                                {/each}
                    ...
                    <div>
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li>
                                <Button href={'tel:' + SITE_DATA.phone.tel} variant="link" 
                            ...
                            <li>
                                <Button href={'mailto:' + SITE_DATA.email} variant="link" 
                                    class="text-sm flex items-center gap-2 justify-start">
                                    <Mail class="w-4 h-4" />
                                    {SITE_DATA.email}
                                </Button>
