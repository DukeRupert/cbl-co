...
<!-- Contact Form -->
<div class="relative isolate bg-white dark:bg-gray-950">
	<div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
		...
		<form use:enhance method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
				...
				<div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
					<div>
						...
						<div class="mt-2.5">
							...
							/>
							{#if $errors.first}
								<span class="text-error-500">{$errors.first}</span>
							{/if}
						</div>
					</div>
					<div>
						...
						<div class="mt-2.5">
							...
							/>
							{#if $errors.last}
								<span class="text-error-500">{$errors.last}</span>
							{/if}
						</div>
					</div>
