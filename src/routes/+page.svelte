...
<main class="isolate bg-white dark:bg-gray-950">
	...
	<div class="relative isolate overflow-hidden bg-gradient-to-b from-emerald-100/20 pt-14">
		<div
			class="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white dark:bg-gray-900 shadow-xl shadow-emerald-600/10 dark:shadow-emerald-800/10 ring-1 ring-emerald-50 dark:ring-emerald-900 sm:-mr-80 lg:-mr-96"
			aria-hidden="true"
		/>
		...
		<div
			class="absolute inset-x-0 bottom-0 -z-10 h-24 bg-gradient-to-t from-white dark:from-gray-950 sm:h-32"
		/>
	</div>
			...
			>
				<div>
					...
					<p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">
						With a dedicated team of experts, state-of-the-art equipment, and a commitment to
						excellence, we are your trusted partner for all things pipeline-related. Explore our
						services below to discover how we can cater to your specific requirements and keep your
						pipelines in optimal condition.
					</p>
				</div>
				<dl
					class="col-span-2 grid grid-cols-1 gap-x-8 gap-y-10 text-base leading-7 text-gray-600 dark:text-gray-300 sm:grid-cols-2 lg:gap-y-16"
				>
			...
			<div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
				<div class="lg:w-full lg:max-w-2xl lg:flex-auto">
					<p class="text-xl leading-8 text-gray-600 dark:text-gray-300">
						At Christian Brother's Lining Co, we are proud to be the frontrunners in the realm of
						Cured-In-Place Piping (CIPP) services, offering a lifeline to municipalities and cities
						across the Golden State. With a profound commitment to the environment and a passion for
						ensuring the longevity of California's vital underground infrastructure, we've dedicated
						ourselves to providing a cost-effective and sustainable alternative to traditional pipe
						replacement.
					</p>
					<div class="mt-10 max-w-xl text-base leading-7 text-gray-700 dark:text-gray-200">
						<p>
							Our team of experts, the true heroes behind the scenes, specializes in the
							rehabilitation and repair of aging or damaged pipes, making use of the cutting-edge
							CIPP technology. By seamlessly creating a new pipe within the existing one, we
							eliminate the need for disruptive and costly excavations. With minimal downtime and
							environmental impact, Christian Brother's Lining Co ensures that your municipality or
							city can continue to function smoothly, even while undergoing essential pipe repairs.
						</p>
						<p class="mt-10">
							We understand that maintaining and improving California's underground infrastructure
							is not just a responsibility; it's a vital service for the well-being of the
							communities we serve. Christian Brother's Lining Co is here to be your partner in this
							crucial mission, striving to make our great state even greater, one pipe at a time.
						</p>
					</div>
				</div>
	...
	<div id="features" class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0">
			...
			<p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
				Cured-In-Place Piping (CIPP) offers several advantages over traditional pipe replacement
				methods, making it a popular choice for pipeline rehabilitation. Here are some of the key
				advantages:
			</p>
		</div>
		<dl
	...
	<div class="relative isolate -z-10 mt-32 sm:mt-48">
		...
		>
			<svg
				class="h-[40rem] w-[80rem] flex-none stroke-gray-200 dark:stroke-gray-800"
				aria-hidden="true"
			>
				<defs>
					<pattern
				...
				<svg x="50%" y="50%" class="overflow-visible fill-gray-50 dark:fill-gray-900">
		...
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<h2 class="text-center text-lg font-semibold leading-8 text-gray-900 dark:text-gray-100">
				Municipalities we have proudly worked with
			</h2>
			<div
			...
			>
				{#each clients as client}
					<div
						class="col-span-2 flex text-center justify-center lg:col-span-1 text-2xl font-semibold text-gray-900 dark:text-gray-100"
					>
						{client}
					</div>
				{/each}
	...
	<div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
		...
		>
			<li>
				...
				/>
				<h3
					class="mt-6 text-lg font-semibold leading-8 tracking-tight text-gray-900 dark:text-gray-100"
				>
					Tom Cook
				</h3>
				<p class="text-base leading-7 text-gray-600 dark:text-gray-300">Director</p>
			...
			<li>
				...
				<p class="text-base leading-7 text-gray-600 dark:text-gray-300">Front-end Developer</p>
				<ul role="list" class="mt-6 flex gap-x-6">
					<li>
						<a href="#" class="text-gray-400 hover:text-gray-500">
							<span class="sr-only">Twitter</span>
			...
			<li>
				...
				<p class="text-base leading-7 text-gray-600 dark:text-gray-300">Senior Foreman</p>
				<ul role="list" class="mt-6 flex gap-x-6">
					<li>
						<a href="#" class="text-gray-400 hover:text-gray-500">
							<span class="sr-only">Twitter</span>
	...
	<!-- CTA -->
	<div class="bg-emerald-700 dark:bg-emerald-800 mt-32 sm:mt-48">
		<div class="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
			<div class="mx-auto max-w-2xl text-center">
				<h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">
					Reimagine Your Pipes.<br />Renew Your Infrastructure!
				</h2>
				<p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-emerald-200">
					Say goodbye to costly excavations and environmental disruptions while ensuring the
					longevity and sustainability of your underground infrastructure. Embrace the future with
					us, and let's get your pipes flowing smoothly again!
				</p>
				<div class="mt-10 flex items-center justify-center gap-x-6">
					<a
						href="tel:+16618164291"
						class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-emerald-600 dark:text-emerald-700 shadow-sm hover:bg-emerald-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
						>Call us</a
					>
